...
<div class="inner-wr">
    <form:form action="${pageContext.request.contextPath}/doctor/editDoctor" method="post" id="editDoc"
        ...
        <form:hidden class="form-control" value="${doctor.doctorId}" path="id"/>
        ...
        <div class="form-group">
            ...
            <form:textarea class="form-control" type="text" value="${doctor.doctorEmail}" path="doctorEmail"></form:textarea>
        </div>
        <div class="form-group">
            <label for="">Telefon</label>
            <form:textarea class="form-control" type="text" value="${doctor.doctorPhone}" path="doctorPhone"></form:textarea>
        </div>
        <div class="form-group">
