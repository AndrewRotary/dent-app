    ...
    <table class="table">
        ...
        <c:forEach items="${apointments}" var="apointment">
            <tr>
                ...
                <td><a href="<spring:url value="/admin/ApointmentCalendar/deleteApointment/${apointment.id}"/> ">Delete
                    <i class="fa fa-trash" aria-hidden="true"></i></a></td>
                <td><a href="<spring:url value="/admin/ApointmentCalendar/editApointment/${apointment.id}"/> "> <i
