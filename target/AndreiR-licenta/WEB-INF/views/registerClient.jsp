...
<div class="wr-register clearfix">
    <form:form action="${pageContext.request.contextPath}/register" method="post"
        ...
        <div class="form-group">
            ...
            <form:input path="clientEmail" id="email" class="form-control input-register" type="text"
                        placeholder="Email"/>
        </div>
        <div class="form-group">
            <form:input path="clientPhone" id="phone" class="form-control input-register" type="text"
        ...
        <div class="form-group">
            ...
            <form:input path="users.username" id="username" class="form-control input-register" type="text"
                        placeholder="Nume Utilizator"/>
        </div>
        <div class="form-group">
            <span style="color: #ff0000">${pswMsg}</span><form:errors
                path="users.password" cssStyle="color: #ff0000"/>
            <form:password path="users.password" id="password" class="form-control input-register"
                           placeholder="Parola"/>
        </div>
