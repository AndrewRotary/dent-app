...
<div class="inner-wr">
    <form:form action="${pageContext.request.contextPath}/doctor/editNews" method="post" id="editNews"
               commandName="news" enctype="multipart/form-data">
        <form:hidden class="form-control" value="${news.id}" path="id"/>
        <div class="form-group">
            <label for="">Titlu</label>
            <form:input class="form-control" value="${news.title}" type="text" path="title"/>
        </div>
        <div class="form-group">
            <label for="">Cuprins</label>
            <form:textarea class="form-control" type="text" value="${news.info}" path="info"></form:textarea>
        </div>
        <div class="form-group">
            <label for="">Link Video</label>
            <form:input class="form-control" type="text" value="${news.linkVideoPath}" path="linkVideoPath"/>
        </div>
        <div class="form-group">
