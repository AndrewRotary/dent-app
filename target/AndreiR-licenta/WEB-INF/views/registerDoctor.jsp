...
<div class="wr-register clearfix">
    <form:form action="${pageContext.request.contextPath}/registerD" method="post"
        ...
        <div class="form-group">
            <form:input path="doctorSurname" id="doctorSurname" class="form-Control input-register"
                        placeholder="Prenume"/>
        </div>

        <div class="form-group">
            <form:input path="doctorDegree" id="doctorDegree" class="form-Control input-register"
        ...
        <div class="form-group">
            <form:input path="users.username" id="username" class="form-Control input-register"
                        placeholder="Nume Utilizator"/>
        </div>
        <div class="form-group">
            <form:input path="users.password" id="password" type="password" class="form-Control input-register"
                        placeholder="Parola"/>
        </div>
        <div class="form-group">
            <label>Descrierea</label>
            <form:textarea class="form-control" type="text" path="about"/>
        </div>
        <div class="form-group">
